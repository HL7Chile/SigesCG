...
Instance: NotProcPost
Title: "Notificación de Procedimientos Posteriores a Cirujía"
Description: "Formularo Caso de Uso 7: Hospital informa de los procedimientos realizados posteriores a la cirujía"
...
* item[=].text = "Datos sobre procedimientos ejecutados posterior a la cirujía"
* item[=].type = #group
* item[=].required = true
* item[=].repeats = true

* item[=].item[+].linkId = "tipoPresEje"
* item[=].item[=].text = "Tipo de prestación otorgada"
* item[=].item[=].type = #group
* item[=].item[=].required = true
